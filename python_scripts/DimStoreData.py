...
excel_file_path_name = "C:/Users/LENOVO SSD/PycharmProjects/DWBI_Project_Real_Life_Data_Integration_with_Snowflake_Python_SQL_PowerBI/lookup_data/LookupFile.xlsx"
...
with open(csv_file, mode='w', newline='') as file:
    ...
    # create the header
    header = ['StoreName', 'StoreType', 'StoreOpeningDate', 'Address', 'City', 'State', 'Country', 'Region',
              'Manager Name']
